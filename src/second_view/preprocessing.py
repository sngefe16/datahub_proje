...
def preprocess_second_view_data(df: pd.DataFrame, 
                                is_train: bool = True) -> pd.DataFrame:
    """
    Preprocess data for second view model.
