    ...
    def fit(self, X_train, y_train, 
        ...
        if categorical_features is None and hasattr(X_train, 'columns'):
            ...
            for col in X_train.columns:
                ...
                # Also check for low-cardinality integer features that might be categorical
...
def train_first_view_model(X_train, y_train,
                          X_val=None, y_val=None,
                          model_params: Optional[Dict] = None,
                          categorical_features: Optional[List[str]] = None) -> FirstViewLightGBM:
    """
    Train first view model.
    ...
    # Initialize model
    model = FirstViewLightGBM(**model_params)
