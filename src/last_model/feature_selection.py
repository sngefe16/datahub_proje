...
def select_features_by_importance(X: pd.DataFrame,
                                  ...
                                  verbose: bool = True) -> tuple:
    """
    Selects features based on LightGBM feature importance.
    
    Args:
        X: Feature dataframe.
        y: Target series.
        model: Trained LightGBM model (if None, trains a simple model).
        top_k: Select top K features.
        importance_threshold: Select features with importance > threshold.
        verbose: Print information.
