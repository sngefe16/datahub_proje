"""Last model training pipeline: calibration, percentile threshold sweep, cost-based threshold."""
...
from src.last_model.data_loader import load_sixth_view_data
from src.last_model.preprocessing import preprocess_sixth_view_data, apply_smote
from src.last_model.feature_engineering import create_all_sixth_view_features
from src.last_model.feature_selection import comprehensive_feature_selection
from src.last_model.models import train_seventh_view_model, train_ensemble_model
from src.last_model.evaluation import (
    evaluate_model, 
...
def main(threshold: float = 0.65,
    ...
    # 1. Load data
    print("\n[1/11] Loading data...")
    train_df, test_df = load_sixth_view_data()  # Use all data (sample_size=None is default)
