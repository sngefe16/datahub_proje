...
def load_second_view_data(data_dir: Optional[str] = None, 
                          sample_size: Optional[int] = None) -> Tuple[pd.DataFrame, pd.DataFrame]:
    """
    Load training and test data with enhanced features.
    ...
    - id_28: Identity feature 28
    - id_29: Identity feature 29
    - id_30: Identity feature 30
    - id_31: Identity feature 31
    ...
    # Test data has dash format, train data has underscore format
    test_id_rename_dict = {}
    ...
    # Keep TransactionID for merge, but we'll exclude it later if needed
...
if __name__ == "__main__":
    # Example usage
    train_df, test_df = load_second_view_data(sample_size=10000)
    print("\nFeature information:")
