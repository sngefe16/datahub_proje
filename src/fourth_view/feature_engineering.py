"""Feature engineering: adds enhanced statistical, lag features, extended combinations."""
...
def create_all_fourth_view_features(df: pd.DataFrame, 
                                   is_train: bool = True) -> pd.DataFrame:
    """
    Create all features for fourth view model.
