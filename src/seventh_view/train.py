...
from src.seventh_view.data_loader import load_sixth_view_data
from src.seventh_view.preprocessing import preprocess_sixth_view_data, apply_smote
from src.seventh_view.feature_engineering import create_all_sixth_view_features
from src.seventh_view.feature_selection import comprehensive_feature_selection
from src.seventh_view.models import train_seventh_view_model, train_ensemble_model
from src.seventh_view.evaluation import (
    evaluate_model, 
...
def main(threshold: float = 0.65,
    ...
    """
    print("=" * 70)
    print("Seventh View Model Training Pipeline")
    print("=" * 70)
    print("Realistic Targets: AUC-ROC >= 0.94, Recall >= 0.85, Precision >= 0.40")
    print("Based on sixth view improvements: overfitting control, better feature selection, improved SMOTE")
    print("=" * 70)
    ...
    # Plot ROC curve
    try:
        plot_roc_curve(y_val, y_val_pred_proba, title="Seventh View Model - ROC Curve")
    except Exception as e:
        print(f"Could not plot ROC curve: {e}")
    
    # Plot Precision-Recall curve
    try:
        plot_precision_recall_curve(y_val, y_val_pred_proba, title="Seventh View Model - Precision-Recall Curve")
    except Exception as e:
    ...
    submission_path = project_root / "results" / "submission_seventh_view.csv"
    ...
    print("\n[12/12] Summary")
    print("=" * 70)
    print(f"Model: Seventh View {'Ensemble' if use_ensemble else 'LightGBM'}")
...
if __name__ == "__main__":
    ...
    model, metrics, threshold_results, optimal_threshold = main(
        ...
        use_ensemble=True,  # Default True for seventh view (better performance)
